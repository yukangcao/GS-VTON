...
def read_boolean_from_file():
    # with open('./att1_value.txt', 'r') as file:
    #     value = file.read().strip().lower()  # Read and remove any surrounding whitespace
        return True  # Convert string back to boolean
...
class UNet2DConditionModel(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin):
    ...
    def __init__(
        ...
        enable_IDM_Attention=read_boolean_from_file()
        
        if enable_IDM_Attention==True:
            from ip_adapter.attention_processor import IPAttnProcessor2_0 as IPAttnProcessor
            from src.modified_attn import XFormersAttnProcessor_Cat_Ref as AttnProcessor
            print("\nAttention Enabled\n")
        else:
