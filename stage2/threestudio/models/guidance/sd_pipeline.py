...
class StableDiffusion(nn.Module):
    def __init__(
        ...
        pipe = DiffusionPipeline.from_pretrained("stabilityai/stable-diffusion-2",torch_dtype=self.dtype).to("cuda")
        pipe.load_lora_weights("/root/autodl-tmp/Lora/dreamboothlora/Output_Model/pytorch_lora_weights.safetensors")
